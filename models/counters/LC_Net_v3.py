...
class SPPE(nn.Module):
    ...
    def __init__(self, c1, c2, k=(5, 9, 13)):
        ...
        self.m = nn.ModuleList([
            nn.MaxPool2d(kernel_size=k[0], stride=1, padding=autopad(k[0])),
            nn.AvgPool2d(kernel_size=k[1], stride=1, padding=autopad(k[1])),
            nn.MaxPool2d(kernel_size=k[2], stride=1, padding=autopad(k[2]))
        ])
...
class CBAM(nn.Module):
    def __init__(self, gate_channels, dummy, reduction_ratio=8, pool_types=['avg', 'max'], no_spatial=False):
